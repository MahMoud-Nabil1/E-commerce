...
/**
 * Utility class for managing JSON Web Tokens (JWT), including generation,
...
public class JwtUtils {
    ...
    /**
     * Decodes the secret key and prepares it for signing or parsing tokens.
     * * @return a Key object for HMAC-SHA algorithms
     */
    private Key key() {
